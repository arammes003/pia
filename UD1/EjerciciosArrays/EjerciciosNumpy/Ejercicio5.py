"""
    5. Escribe un programa que genere 20 números enteros entre 100 y 999.
...
def generate_matrix_random_numbers():
...
def main():
    matrix = generate_matrix_random_numbers()
    print("Original matrix:\n")
    print(f"{matrix}\n")

    print_sheet(create_sheet(matrix))
